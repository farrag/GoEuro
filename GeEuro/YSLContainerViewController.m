...
static const CGFloat kYSLScrollMenuViewHeight = 60;
...
{
    float percentageScrolledOnCurrentPage = scrollView.contentOffset.x / (scrollView.frame.size.width) ;
    
    int currentIndex = round(percentageScrolledOnCurrentPage);
    ...
    self.currentIndex = (scrollView.contentOffset.x / _contentScrollView.frame.size.width);
